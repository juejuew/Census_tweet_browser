    ...
    html.Div([
        ...
        html.Div(id='advanced_options', children=[
            html.Div(children='''
                ...
                The choices of dimension reduction methods are PCA and UMAP. 2nd Stage Dimension Reduction always reduces to 2 dimension for plotting.
                The choices of clustering methods are Gaussian Mixture Model, K-Means, and HDBSCAN.
                ...
                For further information about each of these methods, see the following: (include hyperlinks here)
            '''),
...
def dimRed_and_clustering(docWordMatrix_orig_json, docWordMatrix_json, allMessages_json, new_indices_json,
    ...
    return dimRed_cluster_plot, display_df_columns, display_df_data, unique_cluster_options, unique_cluster_options, json.dumps(cluster_ids_dict)
