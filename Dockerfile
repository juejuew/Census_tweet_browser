...
### Packages
RUN pip install dash dash_bootstrap_components dash_html_components dash_table dash_extensions dash_uploader rpy2 sklearn spicy nltk umap umap-learn hdbscan chart_studio xlrd leidenalg igraph
